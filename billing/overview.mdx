...
description: Plans, invoices, bill runs, transactions, payments, and payment methods
---
...
- **[Plans](/billing/plans)** — Create and manage membership plans (pricing, interval, access).
- **[Transactions](/billing/transactions)** — View all financial transactions.
- **[Invoices](/billing/invoices)** — Create, send, and track invoices.
- **[Bill runs](/billing/bill-runs)** — Automated billing cycles and batch invoicing.
- **[Payments](/billing/payments)** — View and manage payment records and status.
- **[Payment methods](/settings/payment-methods)** — Configure which payment methods your organization accepts (Settings → Billing → Payment methods).
