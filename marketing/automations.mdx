...
Automations replace the previous Campaigns feature. Reminders, review requests, and segment messaging are all modeled as automations now.
...
4. The background worker picks up scheduled steps every minute and executes them in order.
...
Built-in automations cover common needs without setup. Two examples ship by default:

- **24 hours before booking** - Reminder via email, push, and in-app.
- **1 hour before booking** - Reminder via push and in-app.
