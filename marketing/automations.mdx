...
| **Review request** | Booking checked in | Waits 2 hours after the session ends, then sends a review request (every 10 sessions, and never more than one a week). | Gym runs bookings |
