...
- Members can check in more than once per day - a member can attend a morning and an evening class, or make a second visit later the same day. A quick re-scan at the door is recognized as the same visit, not a duplicate
