...
- Members can check in more than once per day. Set a **Daily check-in limit** on the plan to cap self-service entries per day - see [Plans](/billing/plans). Staff check-ins are never blocked by the limit
