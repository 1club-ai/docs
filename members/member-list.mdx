...
- **Archive N selected** - moves the selected contacts to the archive. Contacts with transactions are archived rather than deleted to preserve financial history.
