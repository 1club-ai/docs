...
<CardGroup cols={2}>
  ...
  <Card title="Corporate admin" icon="building" href="/members/corporate-admin">
    The self-serve dashboard where a company account's own administrator manages its employee roster.
  </Card>
</CardGroup>

This section is the admin's side of member management. For what members themselves do - booking, paying, and checking in from the portal, app, or kiosk - see the [Member experience](/member-experience/overview) section.
