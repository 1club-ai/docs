...
Payment timing — whether members pay at booking, at check-in, or not at all — is configured per booking policy. See [Booking Policies](/operations/booking-policies) for the **Require Payment Upfront** and **Require Payment at Check-in** toggles, refund tiers based on cancellation timing, and worked examples.
