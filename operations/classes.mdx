...
The class management system lets you create, schedule, and manage fitness classes, group activities, and training sessions with instructor assignments, capacity limits, and booking tracking.
