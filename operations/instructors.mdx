...
The instructor management system lets you manage your coaching staff, track their schedules, set hourly rates, manage their availability, and monitor their classes and bookings.
...
1. Navigate to **Staff → Instructors** in the admin panel
...
You can also clear the instructor type. When no type is set, the instructor shows **None** rather than a blank value.
...
Instructors have access to a personal earnings dashboard showing a breakdown of their compensation. This is separate from the admin view and accessible only to the instructor after logging into the instructor portal.

### Dashboard Metrics

The top of the earnings page shows four summary cards for the selected period:

- **Total Earnings** — Total compensation earned
- **Total Classes** — Number of classes taught
- **Attendance** — Total members across all classes
- **Personal Training Sessions** — One-on-one bookings completed

### Earnings Chart

The daily earnings bar chart lets instructors visualize compensation over time:

- **Drag to select** a range of bars to drill into a specific date range
- **Filter by timeframe** — Last 7 days, 30 days, 90 days, or a custom date range
- The selected range updates the summary cards and the earnings breakdown below

### Earnings by Work

Below the chart, earnings are broken down by individual class or booking:

| Column | Description |
|--------|-------------|
| **Name** | Class name or personal training session |
| **Type** | Class or standalone booking |
| **Count** | Number of attendees or sessions |
| **Earnings** | Compensation for that item |
