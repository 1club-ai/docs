...
keywords: ["waitlist", "waiting list", "full class", "class capacity", "notify", "claim offer", "auto-book", "cancellation", "queue position", "claim window", "promote next", "booking policy"]
---
