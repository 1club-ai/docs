...
- **Booking Policies** (`Settings → Booking Policies`)- controls whether payment is required at booking or at check-in, and whether bookings require a member account. See [Booking Policies](/operations/booking-policies).
