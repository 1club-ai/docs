...
All data in 1Club is scoped by **organization**. An organization can have multiple **clubs** (locations or venues). Users can belong to more than one organization; when they log in to the admin they work in the context of one organization at a time.
