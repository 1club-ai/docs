...
The weekly series behind a [season pass](/operations/season-passes) is also exempt, and no
override is needed. **Max. ahead** exists to stop one member helping themselves to scarce
near-term inventory ahead of everyone else. A season pass is the opposite: the gym sold
those hours deliberately, months in advance, and the member paid for every week. So a venue
can keep a two-week horizon for casual bookings and still sell a six-month season.
