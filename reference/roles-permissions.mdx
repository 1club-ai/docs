...
1Club uses role-based access control (RBAC). Each admin user has one role that determines which areas of the admin they can see and what they can do (view, create, update, delete, or full manage).
