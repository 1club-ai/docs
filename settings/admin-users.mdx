...
Staff can sign into the admin dashboard with **Google**, **Apple**, or an email and password. See [Signing in](/reference/sign-in) for all supported methods and how to add a password to an account that was created with Google or Apple.
