...
- **MCP** is separate from API tokens. Open **Settings > Artificial Intelligence > AI assistants (MCP)** to copy the endpoint, review connected assistants, and revoke OAuth grants. See [Connect an assistant](/mcp/connect).
