...
An external program is a third-party offering - a partner curriculum, a corporate-wellness benefit, a federation pass - that members can use as their entrance method at check-in, optionally with an extra per-visit fee.
