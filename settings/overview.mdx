...
Settings is where you configure your organization, clubs, billing, member-facing apps, and integrations. All options are available from the main **Settings** page in the admin; the checklist on that page helps you complete the steps needed to go live.
